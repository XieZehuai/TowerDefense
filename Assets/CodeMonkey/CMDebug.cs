...
namespace CodeMonkey
{
    ...
    public static class CMDebug
    {
        ...
        {
            return World_Sprite.CreateDebugButton(parent, localPosition, text, ClickFunc, fontSize,
                paddingX, paddingY);
        }
        ...
        public static UI_Sprite ButtonUI(Transform parent, Vector2 anchoredPosition, string text,
            Action ClickFunc)
        {
        ...
        public static void Text(string text, Vector3 localPosition = default(Vector3),
            ...
            int sortingOrder = UtilsClass.DEFAULT_SORTING_ORDER)
        {
            UtilsClass.CreateWorldText(text, parent, localPosition, fontSize, color, textAnchor,
        ...
        public static FunctionUpdater TextUpdater(Func<string> GetTextFunc, Vector3 localPosition,
            ...
            int sortingOrder = UtilsClass.DEFAULT_SORTING_ORDER)
        {
            return UtilsClass.CreateWorldTextUpdater(GetTextFunc, localPosition, parent, fontSize,
        ...
        public static void DebugProjectile(Vector3 from, Vector3 to, float speed,
        ...
        public static GameObject DrawSpriteTimed(Vector3 position, Sprite sprite, float scale,
            float timer)
        {
        ...
        public static GameObject DrawSpriteTimedAlpha(Vector3 position, Sprite sprite, float scale,
            float timer, float startDecayTimeNormalized = .8f)
        {
